							...
							<div class="row row-custom">
								<div class="col-md-12">
									<div style="padding: 10px 0px 0px 20px;">
										...
										<input type="text" class="form-control" name="ux_txt_email_address_notifications" id="ux_txt_email_address_notifications" value="<?php echo esc_attr( get_option( 'admin_email' ) ); ?>">
									</div>
									<div class="textalign">
								...
								<div class="col-md-12 terms">
									...
									<span> - </span>
									<a href="<?php echo esc_url( TECH_BANKER_URL ); ?>/terms-conditions/" target="_blank"><?php echo esc_attr( $mb_wizard_terms . ' &amp; ' . $mb_wizard_conditions ); ?></a>
								</div>
							</div>
						</div>
					</div>
