<?php
	...
	if (isset($_POST['entrar'])){
		...
		$teste = DBQuery('wp_cadastro', "WHERE usuario = '$usuario' AND senha = '$senha'");
						...
						<form name="form_cadastro" id="form_cadastro">
							<p>Cadastro</p>
								<div class="agenda-nome">
									...
									<input type="text" name="name" id="nome_cadastro">
								</div>
								<div class="agenda-email">	
								...
								<div class="cel">
									...
									<input type="text" name="telefone" id="telefone_cadastro">
								</div>

								<div class="cel">
									<label for="login">Usuário *</label><br/>
									<input type="text" name="usuario" id="login_cadastro">
								</div>
