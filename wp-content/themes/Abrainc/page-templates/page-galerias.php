...
$DiasMes = array('01' => '31',
				...
				'12' => '31');
?>
	<section class="noticias artigos indicadores eventos galeria">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<form role="search" method="get" id="advanced-searchform" class="advanced-searchform" name="advanced-searchform" action="/galeria/">
						<div class="row">
							<div class="form-group col-md-12">
								<p>Busque uma galeria</p>
		...
		<?php 
			...
			$link_back = '/galeria/?mes='.$mes_anterior.'&ano='.$ano_back;	
